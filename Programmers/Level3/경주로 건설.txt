...
class Solution {
    public int solution(int[][] board) {
        ...
        while(!queue.isEmpty()){
            ...
            for(int nextDir=0; nextDir4; nextDir++){
 ...
 class Solution {
     ...
     public int solution(int[][] board) {
         ...
         for(int i=0; ivisited.length; i++){
             for(int j=0; jvisited[0].length; j++){
         ...
         while(!queue.isEmpty()){
             ...
             for(int direction=0; direction4; direction++){
